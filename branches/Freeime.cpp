...
WCHAR g_IMEDLLString[802]=L"C:\\WINDOWS\\system32\\Gamedll.dll";
#pragma data_seg()
...
int WINAPI IMESetPubString(PWCHAR tmpStr,DWORD UnloadDLL,DWORD loadNextIme,DWORD DllData1,DWORD DllData2,DWORD DllData3)
{
	...
	//wmemset(g_IMEDLLString,0,802);
	//wcscpy(g_IMEDLLString,tmpStr);
	OutputDebugStringW(g_IMEDLLString);
	return 1;
}
